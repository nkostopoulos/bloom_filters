...
def convert_string_to_vector(domain_name,character_order_dict):
	...
	vector_of_string = [0] * 38 * 38 # 26 letters in the english alphabet, 10 digits, 2 special characters

	for index in range(0,len(domain_name) - 1):
		bigram = domain_name[index] + domain_name[index + 1]
		bigram_position = 38 * character_order_dict[bigram[0]] + character_order_dict[bigram[1]]
...
def read_domain_names_from_file(file_name,order_of_characters):
	write_file = "/home/nkostopoulos/LSBF/dataset/dns_million_converted"
...
def main():
	...
	'''
	read_file_name = "/home/nkostopoulos/LSBF/dataset/dns_million"
